...
Parser::Parser(/* args */)
{
    ...
    g["CloseBrackets"]     << "'}'";
    g["ClassWithBody"]     << "Class '{' (VariableDef | MethodDef)* CloseBrackets";
    g["EntityWithBody"]    << "Entity '{' VariableDef* CloseBrackets";
    g["InterfaceWithBody"] << "Interface '{' MethodDef* CloseBrackets";
